...
from PySide2.QtWidgets import QLabel, QProgressBar, QFrame, QVBoxLayout, QWidget
...
class Ui_SplashScreen(object):
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate(
            "SplashScreen", u"<strong>Movidesk</strong> to <strong>Trello</strong>", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong></strong>", None))
    # retranslateUi
