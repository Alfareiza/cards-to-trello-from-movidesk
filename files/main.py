...
# ==> SPLASH SCREEN
from files.ui_splash_screen import Ui_SplashScreen
...
class SplashScreen(QMainWindow):
    def __init__(self):
        ...
        QtCore.QTimer.singleShot(1500,
                                 lambda: self.ui.label_description.setText("<strong>OBTENDO</strong> INFORMAÇÕES"))
        QtCore.QTimer.singleShot(3000, lambda: self.ui.label_description.setText(
            "<strong>CARREGANDO</strong> INTERFACE GRÁFICA"))
